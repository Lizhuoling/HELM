...
class Gr00tN1d7Config(PretrainedConfig):
    ...
    # HELM context parameters. DreamZero/Wan produces context tokens that are
    # appended to frozen N1.7 VLM tokens before the action head.
    use_wam_vla_lora: bool = True
